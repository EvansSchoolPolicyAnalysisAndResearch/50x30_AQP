                                      ...
                                      tabPanel("About AgQuery 50x30",
                                               fluidRow(column(1), column(8,
                                                                          HTML(paste('<div style="font-size: 0.9em; margin: 20 0 0 0;">',
                                                                                     ...
                                                                                     '<table><tr><td align="center"><figcaption style="font-size: 1em;" >Diagram of "The Pentagonal Strategy - Phase I" for Growth, Employment, Equity, Efficiency, and Sustainability</figcaption><figure><img src="Tikz_figure_2.png" width=450></figure></td></tr></table>',
