#install.packages(c("shiny", "shinyBS", "tools", "readstata13", "sf", cowplot", "stringr", "DT", "glue", "rlang", "shinyWidgets", "gridExtra", "ggdist","openxlsx", "purrr", "rintrojs",  "corrplot", "plotly", "bslib", "thematic","ragg", "viridis", "heatmaply", "import", "spatstat.geom", "ggtext", "shinyjs"))
...
setwd("C:/Users/vanisha4/Documents/GitHub/50x30_AQP/agquery/")
...
ui <- fluidPage(bg = "white", fg = "#3B528BFF", info="#474481", primary = "#440154FF",
                ...
                fluidRow(column(3, align='center', HTML("<img src='moa_logo.png' width='50%'></img>")),
                         column(3, HTML("<h2>CAS Survey Data Explorer</h2>")),
                         column(3, align='center', HTML("<img src='cam_flag.png' width='50%'></img>")),
                ...
                navbarPage(title="", theme = bslib::bs_theme(version="3",
                           ...
                           tabPanel("Introduction", column(1),column(10, #To do: move this to a separate file.
                                                                     ...
                                                                     img(src='logic-model.png', width='100%'),
                                                                     hr(),
